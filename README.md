...
* Αν δίνεται η παράμετρος `-d` θα εμφανίζονται στην οθόνη του υπολογιστή η γραφική απεικόνιση του γράφου και του κάθε συνόλου, όπως στις παραπάνω εικόνες της εκφώνησης. Προσοχή, δεν χρειάζεται οι εικόνες να είναι ακριβώς οι ίδιες με αυτές της εκφώνησης, μπορεί η διάταξη των κόμβων στο επίπεδο να διαφέρει.
...
5. Μπορείτε να χρησιμοποιήσετε ό,τι θέλετε από τη [βιβλιοθήκη της Python](https://docs.python.org/3/library/).
